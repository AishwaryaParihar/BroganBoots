  ...
  return (
    <div>
      ...
      <div className="row mt-5">
        <h4 className="text-center text-decoration-underline">Contact Us</h4>
        <div className="col-lg-5 col-md-5 col-12 mt-4">
          {/* Section Title Start */}
          <div className="mb-4">
            <h2 className="h3">Keep in Touch with us</h2>
            <p>
          ...
          <div>
            ...
            <span className="d-block">
              ...
              <a href="mailto:broganboots19@gmail.com">broganboots19@gmail.com</a>
            </span>
          </div>
        </div>
